...
const Ubicaciones = () => {
    return(
        <div className="flex flex-col text-center items-center bg-gray-100">
            <div className="w-full py-36 text-white bg-[#EA8239]">
                <h1 className="text-7xl my-5">Ubicaciones</h1>
                <p className="text-3xl">Visítanos en tu sucursal más cercana</p>
            </div>
            <div>
                <div className="flex flex-col py-10 gap-10 items-center">
                    <div className="grid grid-cols-3 grid-rows gap-8">
                        <h3 className="text-6xl col-span-3 text-[#8F2C02] font-semibold">Cancún</h3>
                        <div className="bg-white shadow-xl flex flex-col p-10 rounded-lg">
